---
id: define-kpi-taxonomy
name: "Define KPI Taxonomy"
description: "Translate the working-backwards into measurable revenue, trust, and veracity KPIs that the prototype will be measured against."
trigger:
  kind: command
  phrase: "/define-kpi"
outputs:
  - name: artifact
    path: artifacts/define-kpi-taxonomy-{timestamp}.md
    kind: document
---
...
Translate the working-backwards into measurable revenue, trust, and veracity KPIs that the prototype will be measured against. This skill is one of several in **AI Product Lifecycle**; agents executing this skill should also surface related skills from the same program if the customer's situation calls for them.
