---
id: instrument-prototype-measurement
name: "Instrument Prototype Measurement"
description: "Wire the KPIs into the prototype so before/after measurement is automatic, not manual."
trigger:
  kind: command
  phrase: "/instrument-prototype"
outputs:
  - name: artifact
    path: artifacts/instrument-prototype-measurement-{timestamp}.md
    kind: document
---
...
Wire the KPIs into the prototype so before/after measurement is automatic, not manual. This skill is one of several in **AI Product Lifecycle**; agents executing this skill should also surface related skills from the same program if the customer's situation calls for them.
