...
**ID:** `fde-orchestration` | **Version:** 1.1.0 | **Always active**
...
**ID:** `ai-native-app-builder` | **Version:** 1.1.0
...
**ID:** `responsible-ai` | **Version:** 1.2.0
...
**ID:** `ai-operations` | **Version:** 1.1.0
...
**ID:** `ai-plc` | **Version:** 1.1.0 | **Source:** [aws-samples/sample-ai-plc](https://github.com/aws-samples/sample-ai-plc)
